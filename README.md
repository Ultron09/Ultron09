...
Active contributor to core machine learning and open-source infrastructure:
* **[pytorch/pytorch](https://github.com/pytorch/pytorch)** — Inductor code caching, effectful linalg ops, and ATen RNN validation.
* **[vllm-project/vllm](https://github.com/vllm-project/vllm)** — Parser tool-calling streaming fixes and GPU model runner CUDA graph metrics.
* **[huggingface/transformers](https://github.com/huggingface/transformers)** — Continuous batching and FlashAttention kernel capability fallbacks.
* **[google/flax](https://github.com/google/flax)** — NNX JAX JIT hashability, key validations, and attention documentation.
...
<div align="center">
  <img src="assets/tech-marquee.svg" width="100%" alt="Tech Stack Marquee" />
</div>
